...
<body>
  ...
  <div class='container'>
    <div class='card customer-id' ondblclick="resetTotal()">
      ...
      <div class="id-number">20000000</div>
    </div>
    ...
    <div class='card'>
      ...
      <div class='csv-grid'>
        ...
        <button onclick="window.open('https://docs.google.com/spreadsheets/d/1UwkqEN0kJmtWqIRhAWDT3SF7z18EFzcqTbvBBSYQ2g8/edit?gid=0', '_blank')"><i class='fas fa-table'></i> Lihat Spreadsheet</button>
        <button onclick="window.open('https://docs.google.com/spreadsheets/d/1UwkqEN0kJmtWqIRhAWDT3SF7z18EFzcqTbvBBSYQ2g8/edit?gid=1921451331=Ringkasan Harian', '_blank')"><i class='fas fa-calendar-day'></i> Ringkasan Harian</button>
        <button onclick="window.open('https://docs.google.com/spreadsheets/d/1UwkqEN0kJmtWqIRhAWDT3SF7z18EFzcqTbvBBSYQ2g8/edit?gid=1685833524=Ringkasan Bulanan', '_blank')"><i class='fas fa-calendar-alt'></i> Ringkasan Bulanan</button>
      </div>
    </div>
  </div>
  ...
  server.on("/report", HTTP_GET, [](AsyncWebServerRequest *request){
    ...
    client.setInsecure();
    HTTPClient http;
    String url = "https://script.google.com/macros/s/AKfycbyfMbjo8-MTxKAONqzZ8V6UyBjg1vQcAVnDP0s5OnW4SYxzrluy9YeFGgUk4x9I9cI8Hg/exec";
